              ...
              <motion.div key="r" initial={{opacity:0,y:8}} animate={{opacity:1,y:0}} className="space-y-3">
                <div className="flex flex-wrap items-center gap-2">
                  <span className={cn("rounded-full px-2.5 py-1 text-xs font-medium",
                    result.message_type === "Complaint" ? "bg-destructive/10 text-destructive" : "bg-info/10 text-info"
                ...
                <Field label="Next steps" value={Array.isArray(result.next_steps) ? result.next_steps.join(" · ") : result.next_steps} accent />
